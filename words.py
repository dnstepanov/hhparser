...
banned_jobs = ['Менеджер по', 'Автор', 'Курьер', 'Мебель', 'труда',
               ...
               'отдел нормативно-справочной']

# Типы вакансий
vac_types = [('Тестировщик', ['Тестиров', 'QA', 'качества', 'test']),
             ('Стажер', ['стажер', 'стажёр']),
             ('СТЗ', ['зрени', 'vision', 'opencv', 'видео']),
             ('Научный сотрудник', ['научный', 'исследоват', 'research', 'алгоритм', 'математ']),
             ('Data scientist', ['data sci', 'machine learn', 'big data', 'data engineer']),
             ('Team lead', ['team', 'lead', 'scrum', 'project manager', 'product manager', 'менеджер проект', 'менеджер it-проект']),
             ('Python', ['Python']),
             ('Базы данных', ['Баз данных', 'SQL']),
             ('DevOps', ['Devops', 'девопс', 'Configuration manager/Build engineer', 'Системный инженер (Linux)', 'поддержке Unix']),
             ('C/C++', ['++', 'Разработчик C']),
             ('Delphi', ['Delphi']),
             ('Документация', ['документац', 'защите инф', 'писатель']),
             ('Техподдержка', ['Customer support', 'поддержк', 'support engineer']),
             ('Начальник отдела/лаборатории', ['Начальник отдела', 'Начальник лаборатории', 'CTO', 'начальника отдела', 'руководителя отдела']),
             ('Программист', ['Программист', 'Software engineer', 'Developer', 'Fullstack'])]
