...
vac_types = [('Тестировщик', ['Тестиров', 'QA', 'качества', 'test', 'quality', 'тестового']),
             ('Стажер', ['стажер', 'стажёр', 'Cтажер']),
             ('СТЗ', ['зрени', 'vision', 'opencv', 'видео', 'изображен']),
             ('Научный сотрудник', ['научный', 'исследоват', 'research', 'алгоритм', 'математ', 'численн', 'R & D', 'R&D', 'Scientist', 'Quantitative']),
             ('Data scientist', ['data sci', 'machine learn', 'big data', 'data engineer', 'нейрон', 'машинно']),
             ...
             ('DevOps/DBA', ['Devops', 'девопс', 'Configuration manager/Build engineer', 'Системный инженер', 'поддержке Unix', 'administrator', 'it engineer', 'Continuous Integration', 'DBA', 'reliability']),
             ('C#', ['.Net', 'C#', 'С# Developer', 'программист С#', 'С#']),
             ('C/C++', ['++', 'Разработчик C', 'Программист C', 'QT', 'драйвер', 'embed', 'firmware']),
             ('Безопасность', ['безопасн', 'пентест', 'malware', 'защищ', 'security']),
             ('PHP', ['PHP']),
             ('Delphi', ['Delphi']),
             ('Ruby', ['Ruby']),
             ('FPGA', ['FPGA', 'ПЛИС']),
             ...
             ('Техподдержка', ['Customer support', 'поддержк', 'support engineer', 'сопровожден']),
             ...
             ('Инженер', ['Инженер']),
             ('ABAP/SAP', ['ABAP', 'SAP']),
             ('Сисадмин', ['Специалист по IT', 'it-специалист']),
