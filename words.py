...
vac_types = [('Тестировщик', ['Тестиров', 'QA', 'качества', 'test', 'quality', 'тестового']),
             ...
             ('Техподдержка', ['Customer support', 'поддержк', 'support engineer', 'сопровожден', 'service desk', 'helpdesk', 'Technical Support']),
             ...
             ('Инженер', ['Инженер']),
             ('ABAP/SAP', ['ABAP', 'SAP']),
             ('Сисадмин', ['Специалист по IT', 'it-специалист', 'системный администратор', 'сетевой админ']),
